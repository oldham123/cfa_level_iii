---
sequence: 1
title: 'Reading 1: CFA Institute Code of Ethics and Standards'
section: 1
...
# Reading 1: CFA Institute Code of Ethics and Standards

## 1.A: Describe the structure of the CFA Institute Professional Conduct Program and the disciplinary review process for the enforcement of the CFA Institute Code of Ethics and Standards of Professional Conduct

- An enquiry can be prompted by any of the following:
  - Self-disclosure in an annual Professional Conduct Statement of involvement in litigation, a criminal investigation, or being the subject of a complaint
  - Written complaints addressed directly to Professional Conduct staff
  - Evidence of misconduct received by the Professional Conduct staff from public sources
  - A CFA exam proctor report of potential violation
  - Analysis of exam materials and monitoring of social media by the CFA Institute

- An enquiry may involve:
  - Requesting a written explanation
  - Requesting an interview with the subject, or third parties
  - Requesting documents or records relevant to the enquiry
...
- The **Code of Ethics** is as follows:
  ...
  - Promote the integrity of the global capital markets for the ultimate benefit of society
...
- The **Standards of Professional Conduct** are as follows:
  - **I. Professionalism**
    - *Knowledge of the Law*
      ...
      - In the event of conflict, comply with the strictest law
      - Do not knowingly participate in, or assist a violation of applicable laws
    ...
    - *Misconduct*
      - Do not engage in dishonesty, fraud, or deceit
      - Do not act in a way that reflects adversely on reputation, integrity, or competence
  - **II. Integrity of Capital Markets**
    - *Material Nonpublic Information*
      - Do not act on, or cause others to act on, material nonpublic information that could affect the value of an investment
    - *Market Manipulation*
      - Do not distort prices or artificially inflate volumes with intent to mislead
  - **III. Duties to Clients**
    ...
    - *Suitability*
      - When in an advisory relationship with a client
        - Make reasonable enquiries as to their experience, objectives, and constraints prior to making recommendations or taking actions
        - Determine that investments are suitable before making recommendations or taking actions
        - Judge suitability within the context of the whole portfolio
      - When responsible for management according to a specific mandate, only make recommendations and take actions consistent with that mandate
    - *Performance Presentation*
      - Reasonable efforts must be made to ensure that performance information is fair, accurate, and complete
    - *Preservation of Confidentiality*
      - Information regarding past, current, and prospective clients must be kept confidential unless:
        - Illegal activities are involved
        - Disclosure is legally required
        - Disclosure is permitted by the client
  ...
  - **V. Investment Analysis, Recommendations, and Actions**
    ...
    - *Communication with Clients and Prospective Clients*
      ...
      - Material changes should be disclosed promptly
      - Limitations and risks associated with the process should be disclosed
  ...
  - **VI. Conflicts of Interest**
    - *Disclosure of Conflicts*
      ...
      - Disclosures should be prominent, plain, and effective
    - *Priority of Transactions*
      - Client and employer transactions should come before personal transactions
  - **VII. Responsibilities As A CFA Institute Member Or CFA Candidate**
    - *Conduct as Participants in CFA Institute Programs*
      - Do not compromise the reputation or integrity of the CFA Institute, the CFA Designation, or CFA Institute programs
    - *Reference to CFA Institute, the CFA Designation, and the CFA Program*
      - Do not misrepresent or exaggerate the meaning of membership in the CFA Institute, of the CFA Designation, or of participation in the CFA Program