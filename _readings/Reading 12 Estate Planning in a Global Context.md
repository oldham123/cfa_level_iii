---
sequence: 12
title: 'Reading 12: Estate Planning in a Global Context'
section: 5
...
- Since probate is costly, investors may attempt to avoid it by organising transfer before death, through things such as *shared ownership*, *living trusts*, *retirement plans*, and so on
...
- **Residence jurisdiction**: All income generated by a country's citizens is taxed by that country, regardless of where it is generated
  - Tests to determine residence vary significantly, and often use subjective criteria, such as personal or economic ties

- Wealth transfers are taxed are treated differently under each:
  - Under source jurisdiction, taxes are paid on transfers occurring within the country, regardless of who makes them
...
- If two countries use means of determining residence that lead them to conclude that the individual is resident in both nations, this may result in that individual being liable to pay taxes on the same assets or income twice
  ...
  - Additionally, **source-source conflict** is also possible, possibly leading to the same result
    - Consider an MNC with revenue generating activity occurring within multiple jurisdictions
